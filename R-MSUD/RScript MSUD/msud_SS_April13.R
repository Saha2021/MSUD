...
msud1 <-read.csv("msud1.csv", header=TRUE)
View(msud1)
summary(msud1)
str(msud1)
...
#FOREST PLOT.........option 1 single plot
...
#1. risk pair= ALA-DEP or DEP-ALA use filter fcn for making risk pair
...
View(msud_exp)
View(msud_exp[,c("ala.dep", "temp.lt", "unadj")])

View(msud2[,c("ala.dep", "ALA-DEP")])

#OPTION 1.................................................................##
    #2. selecting temporality var using filter fn from dataset msud2
ala.dep.lt <- dplyr::filter (msud_exp, temporality_type == "LT")
View(ala.dep.lt)
    ...
    #for studies reporting 2X2 data use escl fcn to obtain log odds ratio and samplinG variance
  ...
  #Now the forest plot............NOT WORKING..........
...
# OPTION 2. MACRO..........NOT WORKING..........LINE 387-388
...
ms <- msud_exp %>% filter(ald.dep == 1 & temp.lt == 1  & unadj == 1 )
unadj_fn(-1, 50)
